...
contract DeployYieldBanks is Script {
    ...
    function _readPlan(string memory json) private view returns (DeploymentPlan memory plan) {
        ...
        plan.config = YieldBankConfig({
            ...
            royaltyBackingBps: _parseBps(json, ".config.royaltyBackingBps"),
            royaltyCreatorBps: _parseBps(json, ".config.royaltyCreatorBps"),
            royaltySinjohBps: _parseBps(json, ".config.royaltySinjohBps"),
            exitTaxBps: _parseBps(json, ".config.exitTaxBps"),
            ...
            metadata: vm.parseJsonAddress(json, ".config.metadata"),
            ...
            accountImplementation: vm.parseJsonAddress(json, ".config.accountImplementation"),
